...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EnergyAwareArgs.
func (in *EnergyAwareArgs) DeepCopy() *EnergyAwareArgs {
	if in == nil {
		return nil
	}
	out := new(EnergyAwareArgs)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *EnergyAwareArgs) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
