...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*EnergyAwareArgs)(nil), (*config.EnergyAwareArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_EnergyAwareArgs_To_config_EnergyAwareArgs(a.(*EnergyAwareArgs), b.(*config.EnergyAwareArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.EnergyAwareArgs)(nil), (*EnergyAwareArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_EnergyAwareArgs_To_v1_EnergyAwareArgs(a.(*config.EnergyAwareArgs), b.(*EnergyAwareArgs), scope)
	}); err != nil {
		return err
	}
...
// Convert_v1_EnergyAwareArgs_To_config_EnergyAwareArgs is an autogenerated conversion function.
func Convert_v1_EnergyAwareArgs_To_config_EnergyAwareArgs(in *EnergyAwareArgs, out *config.EnergyAwareArgs, s conversion.Scope) error {
	return autoConvert_v1_EnergyAwareArgs_To_config_EnergyAwareArgs(in, out, s)
}
...
// Convert_config_EnergyAwareArgs_To_v1_EnergyAwareArgs is an autogenerated conversion function.
func Convert_config_EnergyAwareArgs_To_v1_EnergyAwareArgs(in *config.EnergyAwareArgs, out *EnergyAwareArgs, s conversion.Scope) error {
	return autoConvert_config_EnergyAwareArgs_To_v1_EnergyAwareArgs(in, out, s)
}
